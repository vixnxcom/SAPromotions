...
const Payment = () => {
    return (
        <div className="flex justify-center items-center bg-black md:h-auto w-full  max-w-[96vw] mx-auto flex-col  rounded-[24px]">
            ...
            <motion.svg width="200" height="170" viewBox="0 0 213 175" fill="none"  className='mt-8'
...
<stop offset="1" stop-color="#0527FF"/>
            ...
            >
               Secure your spot by making payments into our via Paystack. Payment details will be sent
